<template>
  ...
  <ion-list v-else-if="messages.length">
    <ion-card v-for="message in messages" :key="message.systemMessageId" class="list-item"
      ...
      <div class="status" v-if="message.statusId">
...
const getTypeName = (typeId: string) => {
  const type = systemMessageStore.getSystemMessageTypes.find((systemMessageType: any) => systemMessageType.systemMessageTypeId === typeId);
