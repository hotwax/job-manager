...
import { albumsOutline, cloudUploadOutline, constructOutline, fileTrayStackedOutline, globeOutline, openOutline, pulseOutline, searchCircleOutline, settingsOutline, timeOutline } from "ionicons/icons";
