...
export const JOB_BULK_JOBS_UPDATED = SN_JOB + '/BULK_JOBS_UPDATED'
export const JOB_BULK_JOBS_TIME_UPDATED = SN_JOB + '/BULK_JOBS_TIME_UPDATED'
export const JOB_BULK_JOBS_FREQ_UPDATED = SN_JOB + '/BULK_JOBS_FREQ_UPDATED'
export const JOB_BULK_JOBS_DATA_UPDATED = SN_JOB + '/BULK_JOBS_DATA_UPDATED'
