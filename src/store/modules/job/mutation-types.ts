...
export const JOB_DATA_MANAGER_LOGS_UPDATED = SN_JOB + '/DATA_MANAGER_LOGS_UPDATED'
export const JOB_DATA_RESOURCE_IDS_UPDATED = SN_JOB + '/DATA_RESOURCE_IDS_UPDATED'