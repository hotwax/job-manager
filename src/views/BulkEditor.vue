      ...
      <section>
        ...
        <ion-card>
          ...
          <ion-item>
            ...
            <ion-select interface="popover" :placeholder="translate('Select run time')" :value="globalRuntime" @ionChange="updateRunTime($event)">
          ...
          <ion-item>
            ...
            <ion-select interface="popover" :interface-options="{ header: translate('Frequency') }" :value="globalFreq" :placeholder='translate("Schedule")' @ionChange=setFrequency($event) @ionDismiss="globalFreq == 'CUSTOM' && setCustomFrequency()">
